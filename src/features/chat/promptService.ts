...
export class PromptService {
  ...
  private composeAgentPrompt(
    ...
    return [
      ...
      "6. After tool calls, send text response summarizing shipped features + key files; no rereads.",
      "Rules: prefer tool calls, add deps in manifests when required, PayPal sandbox focus.",
