...
function resolveWorkspaceUri(candidate: string): vscode.Uri {
...
function relativeUriPath(uri: vscode.Uri): string {
...
function isWithin(parent: vscode.Uri, candidate: vscode.Uri): boolean {
